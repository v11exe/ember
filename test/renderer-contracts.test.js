...
test('new tab keeps Ember content above configurable native double-blur layers', () => {
  ...
  assert.match(js, /--native-glass-tilt-x/)
  assert.match(js, /--native-glass-elasticity/)
  assert.match(css, /html,\s*body\s*\{[^}]*background:\s*transparent/)
  assert.match(css, /\.search[\s\S]+backdrop-filter:\s*blur\(/)
  assert.match(css, /\.search[\s\S]+background:\s*rgba\(/)
  assert.match(css, /\.go[\s\S]+background:\s*transparent/)
  assert.match(css, /\.search[\s\S]+--native-glass-tilt-x/)
  assert.match(css, /\.search[\s\S]+transform:/)
