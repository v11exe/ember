...
- **7. Instant / Favorite sidebar buttons** — a collapsible feature rail with editable persistent shortcuts, open-site state, tab-to-Favorite pinning and one-action removal; matching tabs are reused or woken instead of duplicated.
